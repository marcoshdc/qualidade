        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 style="width: 100%" class="box-title">Informações da Colheita</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                @if(!empty($dados->id))
                ...
                @endif
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$dados->total_cana}}" id="total_cana" name="total_cana" placeholder="Total de Cana" style="width: 30%" >
                        </div>
                        <div class="form-group">
                            <label for="perda">Perda</label>
                            <input type="text" class="form-control" value="{{$dados->perda}}" id="perda" name="perda" placeholder="Pontos de Perda" style="width: 30%">
                        </div>
                        <div class="form-group">
                            <label for="erradicacao">Erradicação</label>
                            <input type="text" class="form-control" value="{{$dados->erradicacao}}" id="erradicacao"  name="erradicacao" placeholder="Pontos de Erradicação" style="width: 30%">
                        </div>
                        <div class="form-group">
                            <label for="pisoteio">Pisoteio</label>
                            <input type="text" class="form-control" value="{{$dados->pisoteio}}" id="pisoteio"  name="pisoteio" placeholder="Pontos de Pisoteio" style="width: 30%">
                        </div>
